...
#define BLOCKS_TOTAL (DISK_SPACE / BLOCK_SIZE) // Total jumlah blok di seluruh disk
#define INODES_TOTAL (INODES_PER_GROUP * GROUPS_COUNT) // Total jumlah inode di semua grup blok
#define SUPERBLOCK_BLOCK 1 // Superblock disimpan di block ke-1
#define BGDT_BLOCK 2 // Block Group Descriptor Table di block ke-2
